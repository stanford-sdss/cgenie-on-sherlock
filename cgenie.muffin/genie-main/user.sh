...
CODEDIR=$CGENIE_MUFFIN_LOCATION/cgenie.muffin
OUTROOT=$CGENIE_MUFFIN_LOCATION/cgenie_output
ARCHIVEDIR=$CGENIE_MUFFIN_LOCATION/cgenie_archive
LOGDIR=$CGENIE_MUFFIN_LOCATION/cgenie_log
